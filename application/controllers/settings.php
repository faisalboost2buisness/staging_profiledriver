    ...
    public function adddealers(){
        ...
        if(isset($dealer_details) && is_array($dealer_details)){
            foreach($dealer_details as $value){
                ...
                echo '<option value="'.$value['registration_id'].'">'.$dealer_name.'</option>';                        
            }
        }
    } 
    /*function to remove dealers from the assigned dealer list*/
    ...
    public function newdealerlist(){
        ...
        if(isset($dealer_details)){
            foreach($dealer_details as $value){         
                ...
                $dealer_name=$value['first_name'].' '.$value['last_name'];                                
                echo '<option value="'.$member_id1.'" >'.$dealer_name.'</option>';                                
            }
        }else{
            ?>                                
