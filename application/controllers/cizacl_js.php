	...
	public function rule_oper()
	{
		...
		function addRule(rule_input,controllers_input,functions_input,state_input,description_input)	{
			...
			main							= $("<tr/>", {"id":"rule_"+array_idx});
				...
				this.rules					= $("<select/>", {"name":"type["+array_idx+"]", "id":"type["+array_idx+"]","class":"select withClearFunctions"});
				...
				this.functions 			= $("<select/>", {"name":"function["+array_idx+"][]", "id":"function["+array_idx+"]["+array_fncn_idx+"]","class":"select withClearFunctions"});
				this.functions.html(fncn_options).val(functions_input);
				
				this.state					= $("<select/>", {"name":"status["+array_idx+"]", "id":"status["+array_idx+"]","class" : "select withClearFunctions"});
		...
		function addController(idx,ctrlr_idx,controllers_input)	{
			...
			controllers			= $("<tr/>", {"id":"ctrlr_"+ctrlr_idx});
				...
				this.controller	= $("<select/>", {"id":"controller["+idx+"]["+ctrlr_idx+"]", "name":"controller["+idx+"][]","class":"select withClearFunctions"});
		...
		function addFunction(idx,fncn_idx,functions_input)	{
			...
			functions			= $("<tr/>", {"id":"fncn_"+fncn_idx});
				...
				this.del.text("'.$this->lang->line("del").'").button({icons: {primary: "ui-icon-trash"},text: false});
				this.fn	= $("<select/>", {"id":"function["+idx+"]["+fncn_idx+"]", "name":"function["+idx+"][]","class" : "select withClearFunctions"});
