...
*/
$config['tables']['users']           = 'registration';
/*$config['tables']['groups']          = 'groups';*/
$config['tables']['groups']          = 'groups';
$config['tables']['dealership']      = 'dealership';
$config['tables']['auto_brand']      = 'autobrand';
$config['tables']['account_managers']= 'registration';
$config['tables']['admin']           = 'registration';
$config['tables']['sub_admin']       = 'registration';
$config['tables']['trainer']         = 'trainer';
$config['tables']['sales_person']    = 'sales_person';
$config['tables']['users_groups']    = 'registration_groups';
$config['tables']['login_attempts']  = 'login_attempts';

/*
 | Users table column and Group table column you want to join WITH.
 |
 | Joins from dealership.id
 | Joins from groups.id
 */
$config['join']['users']  = 'registration_id';
 ...
 */
$config['site_title']                 = "Exclusive Private Sale Inc";       // Site Title, example.com
$config['admin_email']                = "ecommercedvlpr@gmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'dealership';           // Default group, use name
$config['admin_group']                = array('admin','sub_admin','sales_person');             // Default administrators group, use name
$config['identity']                   = 'email_id';          // A database column which is used to login with
...
$config['email_dealership'] = 'email_dealership.tpl.php';
