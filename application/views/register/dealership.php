<?php
    ...
    $membership_name =  (is_object($user)) ? $user->first_name.' (Dealer)' : 'Dealership Registration'; ;
?>
            ...
            <div class="six-columns twelve-columns-tablet" style="float: none;margin: 0 auto;width: 529px;">
                <fieldset class="fieldset">
                    ...
                    <p class="inline-small-label button-height" id="canadian_state">
                        ...
                        <?php //echo form_dropdown("canadastate",$states,$canadastate,'id="states" class="select validate[required]" style="text-align: left;"'); ?>
                    ...
                    <p class="inline-small-label button-height">
                        ...
                        <input type="text" name="dealership_email" id="dealership_email" class="input validate[custom[email]]" value="<?php echo $dealership_email; ?>" data-tooltip-options='{"position":"right"}' />
                    </p>
                    ...
                    <p class="inline-small-label button-height">
                        ...
                        <select id="states" name="data_source" class="select validate[required]" style="text-align: left;" >
                            <option value="authenticom" <?php echo ($data_source == 'authenticom') ? 'selected="selected"' : ''  ?>>Authenticom</option>
                            <option value="pbs_direct" <?php echo ($data_source == 'pbs_direct') ? 'selected="selected"' : ''  ?>>PBS Direct</option>
                        </select>
                     </p>
                    <p class="inline-small-label button-height">
