...
<!-- Main content -->
    <section role="main" id="main">
        ...
        <!--heading-->
            <p class="wrapped left-icon icon-info-round">Assigned Dealers Details
                <!--Button to return back-->
                <button type="button" class="button glossy mid-margin-right" onclick="back_form();" style="float: right;">
                    <span class="button-icon green-gradient"><span class="icon-backward"></span></span>Back
                </button>
            </p>
            <?php
                        ...
                        if($value['usertype']!='admin'){
                            ...
                            <tr>
                                <th scope="row" class="align-center hide-on-mobile" style="text-align: center;width: 6%;"><?=$i?></th>
                                    <?php
                                    if($value['usertype']!='admin' || $value['usertype']!='account_managers'){
                                    ?>
                                        <td style="padding-left:19px;width: 23%;" class="align-center hide-on-mobile"><a href="<?=base_url()?>dashboard/dealerdashboard/<?=$value['registration_id']?>"><label><?=ucfirst($value['company_name'])?></label></a><a class="list-link icon-user"  style="float: right;line-height: normal;margin-top: 0;" title="View Profile" href="<?=base_url()?>dashboard/viewdashbord/<?=$value['registration_id']?>">&nbsp;</a></td>
                                    <?php
                                    }else{
                                    ?>
