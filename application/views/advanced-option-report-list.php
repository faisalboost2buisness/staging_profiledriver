...
//                        $customer_leadlist_check=$this -> main_model -> get_total_count_advance_options($event_insert_id,$dealer_id_upload_data,$lead_group='');                  
                    ...
                    ?>
                <span style="float: right;" class="total_leads">Total Leads : <label id="totalleadget"><?=$total_count_show?></label></span>
                </p>
        ...
        ?>
            ...
            $commoncheck=0;
                foreach($group_1_details as $value_group1){
                    ...
                    $customer_data=$return_group[1];//$this -> settings_model -> get_advanced_option_group_details($event_insert_id,1,$dealer_id_upload_data,$leadlist_id,$query_date_range,$returnvalue_group[1]); 
                    ...
                    ?>
                    <div class="slidingbackground">
                        <div class="checkboxalignclass">
                            <input type="checkbox" name="equity_scrap" id="equity_check-all-pr1" class="check-all-pr1" value="1" style="margin-top:7px;"<?php echo $check_all?>  onclick="togglecheckboxes(this,'checkedpr1[]')" >
                        </div>
                        <div style="width: 83%;"><a href="javascript:void(0)" class="show_hide " >Report Group 1: <?php echo $group_name_1;?>
                            <span class="ui-icon ui-icon-triangle-1-e ui-iconsv" style=" margin-top: -1px;"></span></a>
                        </div>
                        <div class="leadstext">Leads : <label id="showcountlable"><?php echo $count_group_1?></label></div>
                    </div>
                        ...
                        <table class="table responsive-table" id="sorting-advanced1">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="" width="25%" class="align-center hide-on-mobile-portrait">Vehicle</th>
...
//                                    }
            ...
            $check_all='';
            $count_group_2='0';
            $group_2_details=$this -> settings_model -> getgroupname_advanced_option($event_insert_id,2);
            if(isset($group_2_details) && $group_2_details!=''){
                foreach($group_2_details as $value_group1){
                    ...
                    $customer_data=$return_group[2];//$this -> settings_model -> get_advanced_option_group_details($event_insert_id,2,$dealer_id_upload_data,$leadlist_id,$query_date_range,$returnvalue_group[2]);
                    if(!empty($customer_data)){
            ...
            $check_all='';
            $count_group_3='0';
            $group_3_details=$this -> settings_model -> getgroupname_advanced_option($event_insert_id,3);
            if(isset($group_3_details) && $group_3_details!=''){
                foreach($group_3_details as $value_group1){
                    ...
                    $customer_data=$return_group[3];//$this -> settings_model -> get_advanced_option_group_details($event_insert_id,3,$dealer_id_upload_data,$leadlist_id,$query_date_range,$returnvalue_group[3]);
                    if(!empty($customer_data)){
            ...
            $check_all='';
            $count_group_4='0';
            $group_4_details=$this -> settings_model -> getgroupname_advanced_option($event_insert_id,4);
            if(isset($group_4_details) && $group_4_details!=''){
                foreach($group_4_details as $value_group1){
                    ...
                    $customer_data=$return_group[4];//$this -> settings_model -> get_advanced_option_group_details($event_insert_id,4,$dealer_id_upload_data,$leadlist_id,$query_date_range,$returnvalue_group[4]);
                    if(!empty($customer_data)){
                    ...
                    $check_all='';
                    $count_group_5='0';
                    $group_5_details=$this -> settings_model -> getgroupname_advanced_option($event_insert_id,5);
                    $group_5_details = NULL;
                    if(isset($group_5_details) && $group_5_details!=''){
                        foreach($group_5_details as $value_group1){
                            ...
                            $customer_data=$return_group[5];//$this -> settings_model -> get_advanced_option_group_details($event_insert_id,5,$dealer_id_upload_data,$leadlist_id,$query_date_range,$returnvalue_group[5]);
                            if(!empty($customer_data)){
