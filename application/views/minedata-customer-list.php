...
$.ajax({
    url: "<?php echo base_url()?>minedata/insertcustomer_lead_list",
    data: 'equity_scrap=' + equity_scrap + '&model_break_down=' + model_break_down+ '&fuel_effciency=' + fuel_effciency+ '&wrranty_scrap=' + wrranty_scrap+ '&custom_campain=' + custom_campain+ '&dealer_id=' + dealer_id+ '&fuel_report6=' + fuel_report6+ '&lead_mining_presets_select=' + lead_mining_presets_select,
    type: "POST",
...
<section role="main" id="main">
    <hgroup id="main-title" class="thin" style="text-align:left;padding-bottom:0px;">
        ...
        <form action="<?=base_url()?>minedata/mailoutoption/<?php echo $dealerid_get?>" method="post" style="margin-top: 12px;" class="leadlist">
            <p class="wrapped left-icon icon-info-round"><?php echo $lead_mining_presets_name_get;?>
                <input type="hidden" name="leadmining_type" value="<?php echo $lead_mining_presets_name_get;?>"/>
                <input type="hidden" name="dealer_id" id="dealer_id" value="<?php echo $dealerid_get;?>"/>
                ...
                // $lead_mining_presets_leadlist=$this -> settings_model -> get_lead_mining_presets_leadlist($event_insert_id_minedata);
                $customer_leadlist_check=$this -> main_model -> total_leadcount_display_mine_data($lead_mining_presets,$dealer_id_upload_data,$event_insert_id_minedata);
            ...
            <input  type="hidden" id="event_id" value="<?=$event_insert_id_minedata?>"/>
        ...
        if($lead_mining_presets=='equity_scrape'){
            $customer_data=$this -> main_model -> customerdatalist($dealer_id_upload_data,0,200,$leadlist_id);
        }else if($lead_mining_presets=='model_breakdown'){
            $customer_data=$this -> main_model -> customerdatalist_model_breakdown_mine_data($dealer_id_upload_data,0,500,'Car',$leadlist_id);
        }else if($lead_mining_presets=='efficiency'){
            $customer_data=$this -> main_model -> customerdatalist_fuel_type_mine_data($dealer_id_upload_data,0,50,'Car',1,$leadlist_id);
        }else if($lead_mining_presets=='warranty_scrape'){
            $customer_data=$this -> main_model -> warrant_scarp_mine_data($event_insert_id_minedata,$dealer_id_upload_data,0,5000,1,$leadlist_id='');
        }
        ...
        <div class="slidingbackground"><div class="checkboxalignclass"><input type="checkbox" name="equity_scrap" id="equity_check-all-pr1" class="check-all-pr1" value="1" style="margin-top:7px;"<?php echo $check_all?>  onclick="togglecheckboxes(this,'checkedpr1[]')" ></div><div style="width: 83%;"><a href="javascript:void(0)" class="show_hide " ><?php echo $group_name[0];?><span class="ui-icon ui-icon-triangle-1-e ui-iconsv" style=" margin-top: -1px;"></span></a></div><div class="leadstext">Leads : <label id="showcountlable"><?php echo $count_equity_scrap?></label></div></div>
            ...
            if($lead_mining_presets=='equity_scrape'){
                ...
                $customer_data=$this -> main_model -> customerdatalist_model_breakdown_mine_data($dealer_id_upload_data,0,500,'SUVS',$leadlist_id);
            }else if($lead_mining_presets=='efficiency'){
                $customer_data=$this -> main_model -> customerdatalist_fuel_type_mine_data($dealer_id_upload_data,0,50,'Car',2,$leadlist_id);
            }else if($lead_mining_presets=='warranty_scrape'){
                $customer_data=$this -> main_model -> warrant_scarp_mine_data($event_insert_id_minedata,$dealer_id_upload_data,0,5000,2,$leadlist_id);
            }
            if(!empty($customer_data)){
        ...
        if($lead_mining_presets=='equity_scrape'){
            ...
            $customer_data=$this -> main_model -> customerdatalist_model_breakdown_mine_data($dealer_id_upload_data,0,500,'Trucks',$leadlist_id);
        }else if($lead_mining_presets=='efficiency'){
            $customer_data=$this -> main_model -> customerdatalist_fuel_type_mine_data($dealer_id_upload_data,0,50,'SUV',3,$leadlist_id);
        }else if($lead_mining_presets=='warranty_scrape'){
            $customer_data=$this -> main_model -> warrant_scarp_mine_data($event_insert_id_minedata,$dealer_id_upload_data,0,5000,3,$leadlist_id);
        }
        if(!empty($customer_data)){
        ...
        if($lead_mining_presets=='equity_scrape'){
            ...
            $customer_data=$this -> main_model -> customerdatalist_model_breakdown_mine_data($dealer_id_upload_data,0,500,'Vans',$leadlist_id);
        }else if($lead_mining_presets=='efficiency'){
            $customer_data=$this -> main_model -> customerdatalist_fuel_type_mine_data($dealer_id_upload_data,0,50,'SUV',4,$leadlist_id);
        }else if($lead_mining_presets=='warranty_scrape'){
            $customer_data=$this -> main_model -> warrant_scarp_mine_data($event_insert_id_minedata,$dealer_id_upload_data,0,5000,4,$leadlist_id);
        }
        if(!empty($customer_data)){
    ...
    if($lead_mining_presets=='equity_scrape'){
        ...
        $customer_data=$this -> main_model -> customerdatalist_model_breakdown_mine_data($dealer_id_upload_data,0,500,'',$leadlist_id);
    }else if($lead_mining_presets=='efficiency'){
        $customer_data=$this -> main_model -> customerdatalist_fuel_type_mine_data($dealer_id_upload_data,0,50,'Truck',5,$leadlist_id);
    }else if($lead_mining_presets=='warranty_scrape'){
        $customer_data=$this -> main_model -> warrant_scarp_mine_data($event_insert_id_minedata,$dealer_id_upload_data,0,5000,5,$leadlist_id);
    }
    if(!empty($customer_data)){
    ...
    if(isset($group_name[5])&& $group_name[5]!=''){
        $customer_data=$this -> main_model -> customerdatalist_fuel_type_mine_data($dealer_id_upload_data,0,50,'Truck',6,$leadlist_id);
