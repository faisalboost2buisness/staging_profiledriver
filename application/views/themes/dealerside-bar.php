...
<div style="clear: both;"></div>
    <ul id="shortcuts" role="complementary" class="children-tooltip tooltip-right">
        <?php
        if($segment=='dashboard' || $segment=='campaign' || $segment=='profile' || $segment=='upload' || $segment=='minedata'){
        ...
        ?>  
        <li><a href="<?=base_url()?>messages/<?=$user_id?>" class="shortcut-settings" title="Messages">Messages</a></li> 
            ...
            <ul class="unstyled-list">
                ...
                <li>
                    ...
                    <li>
                        ...
                        <strong class="blue"><a href="mailto:nate@boost2business.ca" >Got an idea?</strong><br/>
                        <span style="margin-left: 8px;">Tell us</span></a>
                    </li>
                    </ul>
                </li>
                ...
                if(isset($get_events) || $get_events!=''){
                $last_date=$get_events[0]['event_end_date']; 
                $start_date=$get_events[0]['event_start_date'];
                $userevent_startdate=date('d M, Y',$start_date);  
                $userevent_lastdate=date('d M, Y',$last_date);        
                ...
                <li>
                    <ul class="message-menu">
                        <li style="min-height: 18px;padding: 14px 65px 2px 22px;">
                            ...
                            <span class="blue"><?php echo $userevent_startdate;?></span>
                            </span>
                        </li>
                    </ul>
                </li>
                ...
                <ul class="message-menu">
                    <li style="min-height: 18px;padding: 14px 65px 2px 22px;">
                        ...
                        <span class="message-info" style="width: 84px;margin-top: 5px;">
                        <span class="blue"><?php echo $userevent_lastdate;?></span>
                        </span>
                    </li>
                </ul>
                </li>
        ...
        <section class="navigable" style="clear: both;">
            <ul class="big-menu">
                <li class="with-right-arrow">All Events
                    <ul class="big-menu">
                    <?php
                    if($segment=='campaign' || $segment=='dashboard' || $segment=='minedata'){
