...
<!--opening Side bar -->
    ...
    <ul id="shortcuts" role="complementary" class="children-tooltip tooltip-right">
        <?php
        if($segment=='dashboard' || $segment=='campaign' || $segment=='profile'){
        ...
        <div id="menu-content">
           ...
           <div id="profile">
            ...
            <ul class="unstyled-list">
                <li class="title-menu">My EPS Team</li>
                <li>
                    <ul class="calendar-menu">
                    <?php
                    if(isset($manager_details)){
                    foreach($manager_details as $manager_value){
                        ...
                        ?>
                            <li>
                                <a href="<?=base_url()?>dashboard/account_mangercontact_details" class="fancybox" title="Manager">
                                     <?php echo $name?>
                                </a>
                            </li>
                        <?php
                        ...
                        ?>
                       <li>
                                <a href="#" class="fancybox" title="Manager">
                                     Not assigned
                                </a>
                            </li> 
                            <?php
                ...
                <li class="title-menu">Your Upcoming Sales Event</li>
                <li>
                <ul class="message-menu">
                <li style="min-height: 18px;padding: 14px 65px 2px 30px;">
                <span class="new-message" style="float: left;">New</span>
                <strong class="blue">Date</strong><br/><br/>
                <span class="message-info" style="width: 84px;">
                <span class="blue">Jan 15, 2014</span>
                </span>
                </li>
                </ul>
                </li>
                ...
                <li style="min-height: 18px;padding: 14px 65px 2px 30px;">
                <span class="new-message" style="float: left;">New</span>
                <strong class="blue">Goal</strong><br/><br/>
                <span class="message-info" style="width: 84px;">
                ...
                <li>
                    <ul class="message-menu">
                        <li style="min-height: 18px;padding: 14px 65px 2px 30px;">
                        <span class="new-message" style="float: left;">New</span>
                        <strong class="blue">Sales</strong><br/><br/>
                        <span class="message-info" style="width: 84px;">
            ...
            <section class="navigable" style="clear: both;">
                <ul class="big-menu">
                    <li class="with-right-arrow">All Events
                        <ul class="big-menu">
                        <?php
                                    if($segment=='upload' ||  $segment=='campaign' || $segment=='dashboard'){
